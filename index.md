...
### 3. The G.O. Coach isn't responding / images aren't loading.
This is almost always a connection issue. Try:
1. Toggle Wi-Fi off and on, or switch to cellular.
2. Force-quit the app and reopen it.
3. Update to the latest version from the App Store / Play Store.
If it still fails, email us with your device model and iOS/Android version.

### 4. Is my food and streak data private?
...
© 2026 Focuser LLC. All rights reserved.
